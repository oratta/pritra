...
class UserMenu extends JsonResource
{
    ...
    public function toArray($request)
    {
        ...
        foreach ($menu_l as $menuId => $menu){
            ...
            $menuInfo_l[$menuId]['recommend']['step']['finishImageUrl'] = $recommendedWorkoutSet_l[$menuId]->step->getFinishImageUrl();
            $menuInfo_l[$menuId]['recommend']['step']['startImageUrl'] = $recommendedWorkoutSet_l[$menuId]->step->getStartImageUrl();
